...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2015 at 06:29 PM
...
INSERT INTO `TRADINGS` (`ID`, `TRADE_PAIR_ID`, `MIN_TRADING_CRYPTOCURRENCY`, `MAX_TRADING_COINS_PERC`, `MAX_TRADING_CRYPTOCOINS_PERC`, `REFUND_PERC`, `CHECK_BAD_BUY`, `CHECK_BAD_SELL`, `CHECK_BAD_SELL_WALLET`, `MIN_PROFIT_PERCENTAGE`, `ENABLED`, `LOGGING`, `RETRIES`) VALUES(1, 2, 0.1, 100, 100, 100, 0, 1, 0, 0.5, 1, 1, 25);