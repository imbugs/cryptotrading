...
CREATE TABLE `FUND_HISTORY` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK_30qidrsd3uy9y03ffoakkyy71` (`CURRENCY`),
  KEY `FK_ofle43cih8ekt19gbvd8dn9tk` (`TRADING_ID`),
  CONSTRAINT `FK_30qidrsd3uy9y03ffoakkyy71` FOREIGN KEY (`CURRENCY`) REFERENCES `CURRENCIES` (`CODE`),
  CONSTRAINT `FK_ofle43cih8ekt19gbvd8dn9tk` FOREIGN KEY (`TRADING_ID`) REFERENCES `TRADINGS` (`ID`)
