...
CREATE TABLE `LIMIT_ORDERS` (
  ...
  `STOPLOSS_RATE` float DEFAULT NULL,
  `TIMESTAMP` datetime DEFAULT NULL,
  `TIMESTAMP_END_OF_ORDER` datetime DEFAULT NULL,
  `COINS` float DEFAULT NULL,
  `CRYPTOCOINS` float DEFAULT NULL,
  `TRADING_ID` int(11) NOT NULL,
  PRIMARY KEY (`INDX`,`TRADING_ID`),
  KEY `FK_l6wfle6trpgj64jy7ccgt8d71` (`TRADING_ID`),
  CONSTRAINT `FK_l6wfle6trpgj64jy7ccgt8d71` FOREIGN KEY (`TRADING_ID`) REFERENCES `TRADINGS` (`ID`)
...
LOCK TABLES `LIMIT_ORDERS` WRITE;
/*!40000 ALTER TABLE `LIMIT_ORDERS` DISABLE KEYS */;
/*!40000 ALTER TABLE `LIMIT_ORDERS` ENABLE KEYS */;
UNLOCK TABLES;
