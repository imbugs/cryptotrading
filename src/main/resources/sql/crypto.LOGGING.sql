...
INSERT INTO `LOGGING` (`ID`,`TIMESTAMP`, `TRADING_ID`, `INDX`, `LEVEL`, `MESSAGE`) VALUES(8, '2015-05-01 00:40:06', 1, 206, 'INFO', 'Kraken buy order succesfully created with order reference: O56ROM-67PMX-6Q7RMJ');
