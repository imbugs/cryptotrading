...
DROP TABLE IF EXISTS `TRADE_CONDITION_TYPES`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `TRADE_CONDITION_TYPES` (
...
LOCK TABLES `TRADE_CONDITION_TYPES` WRITE;
/*!40000 ALTER TABLE `TRADE_CONDITION_TYPES` DISABLE KEYS */;
/*!40000 ALTER TABLE `TRADE_CONDITION_TYPES` ENABLE KEYS */;
UNLOCK TABLES;
