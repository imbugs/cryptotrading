...
public class PosTrendChangeTest {
    ...
    public void testPosTrendChange() {
        ...
        // Index = 7, period = 3
        posTrendChange.setIndex(7);
        tradeCondition.setPeriod(3);

        assertTrue(posTrendChange.evaluate());

        // Index = 6, period = 3
        posTrendChange.setIndex(6);
        tradeCondition.setPeriod(3);

        assertFalse(posTrendChange.evaluate());
